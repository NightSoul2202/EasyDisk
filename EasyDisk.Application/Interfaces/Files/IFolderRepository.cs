...
namespace EasyDisk.Application.Interfaces.Files
{
    public interface IFolderRepository
    {
        ...
        Task<FolderEntity?> GetByIdIncludingDeletedAsync(int id, string userId);
        Task<FolderEntity?> GetByIdWithFilesIncludingDeletedAsync(int id, string userId);
        Task<List<FolderEntity>> GetByParentIdIncludingDeletedAsync(int parentId, string userId);
